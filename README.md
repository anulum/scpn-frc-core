...
deployable artefact. Formation-method and fuel-cycle choices (including
aneutronic ambitions) are configuration facets, not separate claims. None
of the evidence-maturity states defined by the reactor family standard has
been reached beyond `architecture_only`.
