...
# SCPN FRC Core — repository-level truth tests
...
REQUIRED_PATHS = (
    ...
    "src/scpn_frc_core/configuration.py",
    "src/scpn_frc_core/errors.py",
    "src/scpn_frc_core/observability.py",
    "src/scpn_frc_core/plan_envelope.py",
    "tests/data/plan_envelope_fixture.json",
    "src/scpn_frc_core/parameters.py",
    "src/scpn_frc_core/physics/__init__.py",
...
def test_manifest_declares_exact_configuration_assignment() -> None:
    ...
    assert manifest["project"] == "SCPN-FRC-CORE"
...
def test_package_agrees_with_manifest_truth() -> None:
    ...
    from scpn_frc_core import OWNED_CONFIGURATIONS, RegistryBinding
