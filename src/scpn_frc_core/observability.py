...
# SCPN FRC Core — diagnostic and clock semantics
...
identities for the field-reversed-configuration plasma this repository owns,
...
from scpn_frc_core.configuration import ConsistencyFinding
from scpn_frc_core.errors import DiagnosticPlanError
...
ROTATIONAL_BAND_HZ: Final = (1.0e03, 1.0e05)

SHOT_DURATION_CEILING_S: Final = 1.0e-02
        ...
        for configuration in self.configurations:
            if configuration not in OWNED_CONFIGURATIONS:
                raise DiagnosticPlanError(
                    ...
                    f"{configuration!r} is not owned by SCPN-FRC-CORE"
                )
...
APPLICABLE_CANDIDATES: Final = (
    CandidateProfile(
        ...
        configurations=("field_reversed_configuration",),
...
class DiagnosticChannelPlan:
    ...
    timing_uncertainty_s
        ...
        candidate is applicable to SCPN-FRC-CORE.
    acquisition_start_s
            ...
            if channel.candidate_id == "closed.resolved_mhd_mode" and not (
                ...
                findings.append(
                    ConsistencyFinding(
                        ...
                        message=(
                            f"declared rotational-mode band "
                            f"{channel.max_signal_frequency_hz:.1f} "
                            "Hz is outside the FRC rotational n=2 instability "
                            "scale of tens of kHz (Tuszewski 1988)"
                        ),
                    )
                )
                ...
                findings.append(
                    ConsistencyFinding(
                        ...
                        message=(
                            ...
                            "longer than the FRC lifetime scale of up to ~10 ms "
                            "(Tuszewski 1988)"
                        ),
                    )
                )
